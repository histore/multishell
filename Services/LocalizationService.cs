...
public class LocalizationService : ILocalizationService
{
    ...
    private static readonly Dictionary<string, string> GermanStrings = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["Theme_Dark"] = "Dunkel",
        ["Theme_Light"] = "Hell",
        ["FontSize_Level_1"] = "Sehr klein (1)",
        ["FontSize_Level_2"] = "Klein (2)",
        ["FontSize_Level_3"] = "Standard (3)",
        ["FontSize_Level_4"] = "Groß (4)",
        ["FontSize_Level_5"] = "Sehr groß (5)",
        ["FontSize_Default_Badge"] = "Standard",
        ["Lang_German"] = "Deutsch",
        ...
        ["Help_Zoom_Shortcuts"] = "Terminal-Schriftgröße vergrößern / verkleinern / zurücksetzen",
        ["Help_Scroll_Shortcuts"] = "Im Terminal-Puffer nach oben / unten blättern",
        ["Help_Buffer_Clear"] = "Terminal-Bildschirm und Scrollback-Puffer leeren",
        ["Help_Copy_Paste"] = "Text kopieren / einfügen (ohne Signalunterbrechung)",
        ...
        ["Help_Feature_4"] = "• Zoom: Strg++, Strg+-, Strg+0 oder Strg+Mausrad zum dynamischen Skalieren der Terminalgröße.",
        ["Help_Feature_5"] = "• Persistenz: Alle Tabs, Pfade und Verläufe werden automatisch gespeichert.",
        ...
        ["About_Font"] = "Terminal-Schriftart:",
        ["About_Font_Value"] = "FiraCode Nerd Font Mono (OFL-1.1)",
        ["About_Third_Party"] = "Drittanbieter-Lizenzen:",
        ["About_Third_Party_Value"] = "THIRD_PARTY_NOTICES.md (OFL, MIT)",
        ...
        ["Profiles_Btn_Browse"] = "Durchsuchen...",
        ["Profiles_Browse_Exe_Title"] = "Ausführbare Datei auswählen",
        ["Profiles_Browse_Dir_Title"] = "Startverzeichnis auswählen",
        ["Profiles_Field_Name"] = "Profilname",
        ["Profiles_Field_Path"] = "Pfad zur ausführbaren Datei",
        ["Profiles_Field_WorkingDir"] = "Startverzeichnis (Standard: Benutzerverzeichnis)",
    ...
    private static readonly Dictionary<string, string> EnglishStrings = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["Theme_Dark"] = "Dark",
        ["Theme_Light"] = "Light",
        ["FontSize_Level_1"] = "Very Small (1)",
        ["FontSize_Level_2"] = "Small (2)",
        ["FontSize_Level_3"] = "Standard (3)",
        ["FontSize_Level_4"] = "Large (4)",
        ["FontSize_Level_5"] = "Very Large (5)",
        ["FontSize_Default_Badge"] = "Standard",
        ["Lang_German"] = "Deutsch",
        ["Lang_English"] = "English",
        ["Lang_French"] = "Français",
        ...
        ["Help_Zoom_Shortcuts"] = "Zoom terminal font in / out / reset to default (also Ctrl+MouseWheel)",
        ["Help_Scroll_Shortcuts"] = "Scroll up / down through terminal buffer",
        ["Help_Buffer_Clear"] = "Clear terminal screen and scrollback buffer",
        ["Help_Copy_Paste"] = "Copy / paste text without signal interruption",
        ...
        ["Help_Feature_4"] = "• Zoom: Ctrl++, Ctrl+-, Ctrl+0 or Ctrl+MouseWheel to dynamically scale terminal font size.",
        ["Help_Feature_5"] = "• Persistence: All tabs, working directories, and histories persist automatically across restarts.",
        ...
        ["Profiles_Btn_Browse"] = "Browse...",
        ["Profiles_Browse_Exe_Title"] = "Select Executable File",
        ["Profiles_Browse_Dir_Title"] = "Select Working Directory",
        ["Profiles_Field_Name"] = "Profile Name",
        ["Profiles_Field_Path"] = "Executable Path",
        ["Profiles_Field_WorkingDir"] = "Working Directory (Default: User Profile)",
    ...
    private static readonly Dictionary<string, string> FrenchStrings = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["Theme_Dark"] = "Sombre",
        ["Theme_Light"] = "Clair",
        ["FontSize_Level_1"] = "Très petit (1)",
        ["FontSize_Level_2"] = "Petit (2)",
        ["FontSize_Level_3"] = "Standard (3)",
        ["FontSize_Level_4"] = "Grand (4)",
        ["FontSize_Level_5"] = "Très grand (5)",
        ["FontSize_Default_Badge"] = "Standard",
        ["Lang_German"] = "Deutsch",
        ["Lang_English"] = "English",
        ["Lang_French"] = "Français",
        ...
        ["Help_Zoom_Shortcuts"] = "Agrandir / réduire / réinitialiser la police du terminal (ou Ctrl+Molette)",

        // Shortcuts & Help Modal
        ["Help_Modal_Title"] = "Raccourcis clavier & Aide",
        ["Help_Modal_Subtitle"] = "Raccourcis clavier de productivité et astuces",
        ["Help_Section_Shortcuts"] = "Raccourcis clavier",
        ["Help_Section_Features"] = "Fonctionnalités",
        ["Help_Shortcut_1_Key"] = "Ctrl + T",
        ["Help_Shortcut_1_Desc"] = "Ouvrir un nouvel onglet de terminal",
        ["Help_Shortcut_2_Key"] = "Ctrl + W",
        ["Help_Shortcut_2_Desc"] = "Fermer l'onglet actif",
        ["Help_Shortcut_3_Key"] = "Ctrl + Shift + T",
        ["Help_Shortcut_3_Desc"] = "Rouvrir le dernier onglet fermé",
        ["Help_Shortcut_4_Key"] = "Ctrl + Tab / Ctrl + Shift + Tab",
        ["Help_Shortcut_4_Desc"] = "Basculer entre les onglets",
        ["Help_Shortcut_5_Key"] = "Ctrl + 1 .. 9",
        ["Help_Shortcut_5_Desc"] = "Passer directement à l'onglet 1 à 9",
        ["Help_Shortcut_6_Key"] = "Ctrl + Shift + H / Alt + H",
        ["Help_Shortcut_6_Desc"] = "Afficher/Masquer le panneau d'historique",
        ["Help_Shortcut_7_Key"] = "Ctrl + + / Ctrl + - / Ctrl + 0",
        ["Help_Shortcut_7_Desc"] = "Agrandir, réduire ou réinitialiser la taille de police",
        ["Help_Shortcut_8_Key"] = "Ctrl + F",
        ["Help_Shortcut_8_Desc"] = "Rechercher dans l'historique des commandes",
        ["Help_Shortcut_9_Key"] = "F1",
        ["Help_Shortcut_9_Desc"] = "Ouvrir cette boîte de dialogue d'aide",
        ["Help_Feature_1"] = "• Multi-Shell : Prise en charge native de PowerShell 7, Windows PowerShell, CMD, WSL et bash.",
        ["Help_Feature_2"] = "• Recherche floue : Filtrage intelligent de l'historique des commandes et des répertoires récents.",
        ["Help_Feature_3"] = "• Détection des liens : Détection automatique des URL et des chemins de fichiers avec ouverture par clic.",
        ["Help_Feature_4"] = "• Zoom : Ctrl++, Ctrl+-, Ctrl+0 ou Ctrl+Molette pour ajuster dynamiquement la taille du terminal.",
        ["Help_Feature_5"] = "• Persistance : Tous les onglets, répertoires et historiques sont enregistrés automatiquement.",
        ...
        ["About_Font"] = "Police de terminal :",
        ["About_Font_Value"] = "FiraCode Nerd Font Mono (OFL-1.1)",
        ["About_Third_Party"] = "Licences tierces :",
        ["About_Third_Party_Value"] = "THIRD_PARTY_NOTICES.md (OFL, MIT)",
        ...
        ["Profiles_Modal_Subtitle"] = "Configurer les profils, modifier les chemins et ajouter de nouveaux shells",
        ["Profiles_Btn_Add"] = "+ Nouveau profil",
        ["Profiles_Btn_Edit"] = "Modifier",
        ["Profiles_Btn_Save"] = "Enregistrer",
        ["Profiles_Btn_Delete"] = "Supprimer",
        ["Profiles_Btn_Default"] = "Définir par défaut",
        ["Profiles_Btn_Cancel"] = "Annuler",
        ["Profiles_Btn_Browse"] = "Parcourir...",
        ["Profiles_Browse_Exe_Title"] = "Sélectionner le fichier exécutable",
        ["Profiles_Browse_Dir_Title"] = "Sélectionner le répertoire de travail",
        ["Profiles_Field_Name"] = "Nom du profil",
        ["Profiles_Field_Path"] = "Chemin de l'exécutable",
        ["Profiles_Field_WorkingDir"] = "Répertoire de travail (par défaut : dossier utilisateur)",
        ["Profiles_Field_Args"] = "Arguments de démarrage (optionnel)",
    ...
    private static readonly Dictionary<string, string> SpanishStrings = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["Theme_Dark"] = "Oscuro",
        ["Theme_Light"] = "Claro",
        ["FontSize_Level_1"] = "Muy pequeño (1)",
        ["FontSize_Level_2"] = "Pequeño (2)",
        ["FontSize_Level_3"] = "Estándar (3)",
        ["FontSize_Level_4"] = "Grande (4)",
        ["FontSize_Level_5"] = "Muy grande (5)",
        ["FontSize_Default_Badge"] = "Estándar",
        ["Lang_German"] = "Deutsch",
        ["Lang_English"] = "English",
        ["Lang_French"] = "Français",
        ["Lang_Spanish"] = "Español",
        ...
        ["Help_Zoom_Shortcuts"] = "Aumentar / disminuir / restablecer fuente del terminal (o Ctrl+Rueda)",
        ["Help_Scroll_Shortcuts"] = "Desplazarse arriba / abajo en el búfer del terminal",
        ["Help_Buffer_Clear"] = "Limpiar pantalla y búfer de desplazamiento del terminal",
        ["Help_Copy_Paste"] = "Copiar / pegar texto sin interrumpir señales",
        ...
        ["Help_Feature_4"] = "• Zoom: Ctrl++, Ctrl+-, Ctrl+0 o Ctrl+Rueda para escalar la fuente.",
        ["Help_Feature_5"] = "• Persistencia: Todas las pestañas, directorios e historiales se guardan.",
        ...
        ["Profiles_Btn_Browse"] = "Examinar...",
        ["Profiles_Browse_Exe_Title"] = "Seleccionar archivo ejecutable",
        ["Profiles_Browse_Dir_Title"] = "Seleccionar directorio de trabajo",
        ["Profiles_Field_Name"] = "Nombre del perfil",
        ["Profiles_Field_Path"] = "Ruta del archivo ejecutable",
        ["Profiles_Field_WorkingDir"] = "Directorio de trabajo (predeterminado: carpeta de usuario)",
