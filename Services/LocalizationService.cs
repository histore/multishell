...
public class LocalizationService : ILocalizationService
{
    ...
    private static readonly Dictionary<string, string> FrenchStrings = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["Help_Scroll_Shortcuts"] = "Faire défiler l'historique du terminal vers le haut / bas",
        ["Help_Buffer_Clear"] = "Effacer l'écran et le tampon de défilement du terminal",
        ["Help_Copy_Paste"] = "Copier / coller du texte sans interrompre les signaux",
        ...
        ["Help_Feature_4"] = "• Zoom : Ctrl++, Ctrl+-, Ctrl+0 ou Ctrl+Molette pour ajuster la taille de police.",
        ["Help_Feature_5"] = "• Persistance : Tous les onglets, répertoires et historiques sont conservés.",
