...
public partial class LocalizationService
{
    ...
    private static readonly Dictionary<string, string> FrenchStrings = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["Help_Scroll_Shortcuts"] = "Défiler vers le haut / bas dans le tampon du terminal",
        ["Help_Buffer_Clear"] = "Effacer l'écran et le tampon de défilement du terminal",
        ["Help_Copy_Paste"] = "Copier / coller le texte sans interruption de signal",
        ...
        ["Help_Feature_1"] = "• Historique : Survoler le bord gauche ou Ctrl+Maj+H. Clic/Entrée pour insérer, clic droit pour exécuter.",
        ...
        ["Help_Feature_4"] = "• Zoom : Ctrl++, Ctrl+-, Ctrl+0 ou Ctrl+Molette pour ajuster dynamiquement la taille.",
    ...
    {
        // Settings Menu
        ["Settings_Menu_Title"] = "Impostazioni & Informazioni",
        ["Settings_App_Theme"] = "Tema applicazione",
        ["Settings_Terminal_Theme"] = "Tema terminale",
        ["Settings_Language"] = "Lingua",
        ["Settings_App_FontSize"] = "Dimensione carattere app",
        ["Settings_Terminal_FontSize"] = "Dimensione carattere terminale",
        ["Settings_Profiles_Title"] = "Profili terminale...",
        ["Settings_Help_Title"] = "Guida & Scorciatoie",
        ["Settings_About_Title"] = "Informazioni su MultiShell",
        ["Theme_Dark"] = "Scuro",
        ["Theme_Light"] = "Chiaro",
        ["FontSize_Level_1"] = "Molto piccolo (1)",
        ["FontSize_Level_2"] = "Piccolo (2)",
        ["FontSize_Level_3"] = "Standard (3)",
        ["FontSize_Level_4"] = "Grande (4)",
        ["FontSize_Level_5"] = "Molto grande (5)",
        ["FontSize_Default_Badge"] = "Standard",
        ["Lang_German"] = "Deutsch",
        ["Lang_English"] = "English",
        ["Lang_French"] = "Français",
        ...
        // Toolbar & Tabs
        ["Btn_New_Tab_Tooltip"] = "Nuova scheda (Ctrl+Shift+T)",
        ["Btn_New_Tab_With_Shell_Tooltip"] = "Nuova scheda {0} (Ctrl+Shift+T)",
        ["Btn_Select_Shell_Tooltip"] = "Seleziona tipo di terminale",
        ["Shell_PowerShell"] = "PowerShell",
        ["Shell_NuShell"] = "NuShell",
        ["Shell_WSL"] = "WSL (Linux)",
        ["Shell_CMD"] = "Prompt dei comandi (CMD)",
        ["Btn_Tab_History_Tooltip"] = "Cronologia scheda (Ctrl+Shift+H)",
        ["Btn_Tab_History_Text"] = "Cronologia",
        ["Btn_Tab_Menu_Tooltip"] = "Panoramica schede (Ctrl+Tab)",
        ["Btn_Tab_Scroll_Left"] = "Scorri schede a sinistra",
        ["Btn_Tab_Scroll_Right"] = "Scorri schede a destra",
        ["Btn_Tab_Close_Tooltip"] = "Chiudi scheda (Ctrl+Shift+W)",

        // Tab Switcher Overlay
        ["Tab_Switcher_Title"] = "SCHEDE APERTE",
        ["Tab_Switcher_Hint_Keyboard"] = "[ Tab ▾  |  Shift+Tab ▴  |  Rilascia Ctrl per aprire  |  Esc Annulla ]",
        ["Tab_Switcher_Hint_Click"] = "[ ▲/▼ Naviga  |  Clic/Invio Apri  |  Esc Chiudi ]",
        ["Tab_Switcher_Count"] = "{0} di {1} schede",

        // Drawer
        ["Drawer_Title"] = "CRONOLOGIA",
        ["Drawer_Tab_Commands"] = "Comandi",
        ["Drawer_Tab_Directories"] = "Directory",
        ["Drawer_Search_Commands_Placeholder"] = "Filtra comandi...",
        ["Drawer_Search_Directories_Placeholder"] = "Filtra directory...",
        ["Drawer_Empty_Commands"] = "Nessun comando eseguito in questa scheda.",
        ["Drawer_Empty_Directories"] = "Nessuna directory registrata in questa scheda.",
        ["Drawer_Hint"] = "[ ▲/▼ Naviga  |  Clic/Invio Inserisci  |  Clic destro Esegui  |  Esc Chiudi ]",

        // Help Modal
        ["Help_Modal_Title"] = "Scorciatoie da tastiera & Utilizzo",
        ["Help_Section_Navigation"] = "SCORCIATOIE",
        ["Help_Section_Tabs"] = "GESTIONE SCHEDE",
        ["Help_Section_History"] = "PANNELLO CRONOLOGIA",
        ["Help_Section_Features"] = "FUNZIONALITÀ",
        ["Help_Close_Button"] = "Chiudi",
        ["Help_Tab_New"] = "Apri nuova scheda PowerShell",
        ["Help_Tab_Dup"] = "Duplica scheda attiva nella directory corrente",
        ["Help_Tab_Next_Prev"] = "Seleziona scheda successiva / precedente",
        ["Help_Tab_Jump"] = "Passa direttamente alla scheda 1..8 o all'ultima (9)",
        ["Help_Tab_Close"] = "Chiudi scheda attiva",
        ["Help_Tab_Move"] = "Sposta scheda attiva a sinistra / destra",
        ["Help_Term_Newline"] = "Inserisci nuova riga nel terminale senza eseguire comando",
        ["Help_Zoom_Shortcuts"] = "Zoom carattere terminale avanti / indietro / reimposta (anche Ctrl+Rotellina)",
        ["Help_Scroll_Shortcuts"] = "Scorri in alto / in basso nel buffer del terminale",
        ["Help_Buffer_Clear"] = "Cancella schermo e buffer di scorrimento del terminale",
        ["Help_Copy_Paste"] = "Copia / incolla testo senza interruzione del segnale",
        ...
        ["Help_Feature_1"] = "• Cronologia scheda: Passa il mouse sul bordo sinistro o premi Ctrl+Shift+H. Clic sinistro/Invio per inserire, clic destro per eseguire.",
        ["Help_Feature_2"] = "• Trascina & Rilascia: Riordina le schede trascinandole con il tasto sinistro del mouse.",
        ["Help_Feature_3"] = "• Schede in eccesso: I pulsanti di scorrimento (‹ ›) e il menu rapido (≡ ▾) appaiono quando le schede superano la finestra.",
        ["Help_Feature_4"] = "• Zoom: Ctrl++, Ctrl+-, Ctrl+0 o Ctrl+Rotellina per ridimensionare dinamicamente il carattere.",
        ["Help_Feature_5"] = "• Persistenza: Tutte le schede, directory di lavoro e cronologie persistono automaticamente tra i riavvii.",

        // About Modal
        ["About_Modal_Title"] = "MultiShell",
        ["About_Modal_Subtitle"] = "Ambiente di lavoro PowerShell ad alte prestazioni",
        ["About_Version"] = "Versione:",
        ["About_Framework"] = "Framework:",
        ["About_UI_Terminal"] = "UI & Terminale:",
        ["About_License"] = "Licenza:",
        ["About_GitHub"] = "Repository GitHub:",
        ["About_Built_With"] = "Creato con:",
        ["About_Built_With_Value"] = "Google Gemini & Antigravity",
        ["About_Footer"] = "Progettato secondo i principi di Clean Architecture & Clean Code.",
        ["About_OK_Button"] = "OK",

        // Profiles Modal
        ["Profiles_Modal_Title"] = "Profili terminale",
        ["Profiles_Modal_Subtitle"] = "Configura profili terminale, percorsi, argomenti e aggiungi shell personalizzate",
        ["Profiles_Btn_Add"] = "+ Nuovo profilo",
        ["Profiles_Btn_Edit"] = "Modifica",
        ["Profiles_Btn_Delete"] = "Elimina",
        ["Profiles_Btn_Save"] = "Salva",
        ["Profiles_Btn_Cancel"] = "Annulla",
        ["Profiles_Btn_Reset"] = "Ripristina predefiniti",
        ["Profiles_Btn_Browse"] = "Sfoglia...",
        ["Profiles_Browse_Exe_Title"] = "Seleziona file eseguibile",
        ["Profiles_Browse_Dir_Title"] = "Seleziona directory di lavoro",
        ["Profiles_Field_Name"] = "Nome profilo",
        ["Profiles_Field_Path"] = "Percorso eseguibile",
        ["Profiles_Field_WorkingDir"] = "Directory di lavoro (predefinita: cartella utente)",
        ["Profiles_Field_Args"] = "Argomenti (facoltativo)",
        ["Profiles_Field_Icon"] = "Etichetta badge (es. PS, CMD, GIT)",
        ["Profiles_Field_ShellType"] = "Tipo di emulazione shell",
        ["Profiles_Edit_Title"] = "Modifica profilo",
        ["Profiles_Create_Title"] = "Crea nuovo profilo",
        ["Profiles_Empty"] = "Nessun profilo configurato.",
    ...
    {
        // Settings Menu
        ["Settings_Menu_Title"] = "Definições & Sobre",
        ["Settings_App_Theme"] = "Tema da aplicação",
        ["Settings_Terminal_Theme"] = "Tema do terminal",
        ["Settings_Language"] = "Idioma",
        ["Settings_App_FontSize"] = "Tamanho da fonte da app",
        ["Settings_Terminal_FontSize"] = "Tamanho da fonte do terminal",
        ["Settings_Profiles_Title"] = "Perfis de terminal...",
        ["Settings_Help_Title"] = "Ajuda & Atalhos",
        ["Settings_About_Title"] = "Sobre o MultiShell",
        ["Theme_Dark"] = "Escuro",
        ["Theme_Light"] = "Claro",
        ["FontSize_Level_1"] = "Muito pequeno (1)",
        ["FontSize_Level_2"] = "Pequeno (2)",
        ["FontSize_Level_3"] = "Padrão (3)",
        ["FontSize_Level_4"] = "Grande (4)",
        ["FontSize_Level_5"] = "Muito grande (5)",
        ["FontSize_Default_Badge"] = "Padrão",
        ["Lang_German"] = "Deutsch",
        ["Lang_English"] = "English",
        ["Lang_French"] = "Français",
        ["Lang_Spanish"] = "Español",
        ...
        // Toolbar & Tabs
        ["Btn_New_Tab_Tooltip"] = "Novo separador (Ctrl+Shift+T)",
        ["Btn_New_Tab_With_Shell_Tooltip"] = "Novo separador {0} (Ctrl+Shift+T)",
        ["Btn_Select_Shell_Tooltip"] = "Selecionar tipo de terminal",
        ["Shell_PowerShell"] = "PowerShell",
        ["Shell_NuShell"] = "NuShell",
        ["Shell_WSL"] = "WSL (Linux)",
        ["Shell_CMD"] = "Linha de comandos (CMD)",
        ["Btn_Tab_History_Tooltip"] = "Histórico do separador (Ctrl+Shift+H)",
        ["Btn_Tab_History_Text"] = "Histórico",
        ["Btn_Tab_Menu_Tooltip"] = "Visão geral dos separadores (Ctrl+Tab)",
        ["Btn_Tab_Scroll_Left"] = "Deslocar separadores para a esquerda",
        ["Btn_Tab_Scroll_Right"] = "Deslocar separadores para a direita",
        ["Btn_Tab_Close_Tooltip"] = "Fechar separador (Ctrl+Shift+W)",

        // Tab Switcher Overlay
        ["Tab_Switcher_Title"] = "SEPARADORES ABERTOS",
        ["Tab_Switcher_Hint_Keyboard"] = "[ Tab ▾  |  Shift+Tab ▴  |  Solte Ctrl para abrir  |  Esc Cancelar ]",
        ["Tab_Switcher_Hint_Click"] = "[ ▲/▼ Navegar  |  Clique/Enter Abrir  |  Esc Fechar ]",
        ["Tab_Switcher_Count"] = "{0} de {1} separadores",

        // Drawer
        ["Drawer_Title"] = "HISTÓRICO",
        ["Drawer_Tab_Commands"] = "Comandos",
        ["Drawer_Tab_Directories"] = "Diretórios",
        ["Drawer_Search_Commands_Placeholder"] = "Filtrar comandos...",
        ["Drawer_Search_Directories_Placeholder"] = "Filtrar diretórios...",
        ["Drawer_Empty_Commands"] = "Nenhum comando executado neste separador.",
        ["Drawer_Empty_Directories"] = "Nenhum diretório registado neste separador.",
        ["Drawer_Hint"] = "[ ▲/▼ Navegar  |  Clique/Enter Inserir  |  Clique direito Executar  |  Esc Fechar ]",

        // Help Modal
        ["Help_Modal_Title"] = "Atalhos de teclado & Utilização",
        ["Help_Section_Navigation"] = "ATALHOS",
        ["Help_Section_Tabs"] = "GESTÃO DE SEPARADORES",
        ["Help_Section_History"] = "PAINEL DE HISTÓRICO",
        ["Help_Section_Features"] = "FUNCIONALIDADES",
        ["Help_Close_Button"] = "Fechar",
        ["Help_Tab_New"] = "Abrir novo separador PowerShell",
        ["Help_Tab_Dup"] = "Duplicar separador ativo no diretório atual",
        ["Help_Tab_Next_Prev"] = "Selecionar separador seguinte / anterior",
        ["Help_Tab_Jump"] = "Saltar diretamente para o separador 1..8 ou último (9)",
        ["Help_Tab_Close"] = "Fechar separador ativo",
        ["Help_Tab_Move"] = "Mover separador ativo para a esquerda / direita",
        ["Help_Term_Newline"] = "Inserir nova linha no terminal sem executar comando",
        ["Help_Zoom_Shortcuts"] = "Aumentar / diminuir / repor tamanho da fonte do terminal (também Ctrl+Roda do rato)",
        ["Help_Scroll_Shortcuts"] = "Deslocar para cima / para baixo no buffer do terminal",
        ["Help_Buffer_Clear"] = "Limpar ecrã e buffer de deslocamento do terminal",
        ["Help_Copy_Paste"] = "Copiar / colar texto sem interrupção de sinal",
        ...
        ["Help_Feature_1"] = "• Histórico do separador: Passe o rato na margem esquerda ou prima Ctrl+Shift+H. Clique esquerdo/Enter para inserir, clique direito para executar.",
        ["Help_Feature_2"] = "• Arrastar & Largar: Reordene os separadores arrastando com o botão esquerdo do rato.",
        ["Help_Feature_3"] = "• Transbordo de separadores: Botões de deslocamento (‹ ›) e menu rápido (≡ ▾) surgem quando os separadores excedem a janela.",
        ["Help_Feature_4"] = "• Zoom: Ctrl++, Ctrl+-, Ctrl+0 ou Ctrl+Roda do rato para dimensionar dinamicamente a fonte.",
        ["Help_Feature_5"] = "• Persistência: Todos os separadores, diretórios de trabalho e históricos persistem automaticamente entre reinícios.",

        // About Modal
        ["About_Modal_Title"] = "MultiShell",
        ["About_Modal_Subtitle"] = "Espaço de trabalho PowerShell de alto desempenho",
        ["About_Version"] = "Versão:",
        ["About_Framework"] = "Framework:",
        ["About_UI_Terminal"] = "UI & Terminal:",
        ["About_License"] = "Licença:",
        ["About_GitHub"] = "Repositório GitHub:",
        ["About_Built_With"] = "Criado com:",
        ["About_Built_With_Value"] = "Google Gemini & Antigravity",
        ["About_Footer"] = "Criado com os princípios de Clean Architecture & Clean Code.",
        ["About_OK_Button"] = "OK",

        // Profiles Modal
        ["Profiles_Modal_Title"] = "Perfis de terminal",
        ["Profiles_Modal_Subtitle"] = "Configurar perfis de terminal, caminhos, argumentos e adicionar shells personalizadas",
        ["Profiles_Btn_Add"] = "+ Novo perfil",
        ["Profiles_Btn_Edit"] = "Editar",
        ["Profiles_Btn_Delete"] = "Eliminar",
        ["Profiles_Btn_Save"] = "Guardar",
        ["Profiles_Btn_Cancel"] = "Cancelar",
        ["Profiles_Btn_Reset"] = "Repor predefinições",
        ["Profiles_Btn_Browse"] = "Procurar...",
        ["Profiles_Browse_Exe_Title"] = "Selecionar ficheiro executável",
        ["Profiles_Browse_Dir_Title"] = "Selecionar diretório de trabalho",
        ["Profiles_Field_Name"] = "Nome do perfil",
        ["Profiles_Field_Path"] = "Caminho do executável",
        ["Profiles_Field_WorkingDir"] = "Diretório de trabalho (predefinição: pasta do utilizador)",
        ["Profiles_Field_Args"] = "Argumentos (opcional)",
        ["Profiles_Field_Icon"] = "Etiqueta (ex. PS, CMD, GIT)",
        ["Profiles_Field_ShellType"] = "Tipo de emulação de shell",
        ["Profiles_Edit_Title"] = "Editar perfil",
        ["Profiles_Create_Title"] = "Criar novo perfil",
        ...
        ["ClosedTabs_RestoreTooltip"] = "Restaurar separador com histórico",
