...
7. **Developer** (`Reasoning: Medium`): Implements clean, maintainable C# / Avalonia code (English comments) strictly adhering to architectural blueprints, UI designs, and requirements.
